...
about_this_car:
  ...
  features:
  - title: "Prestige & Space"
    icon: "fas fa-gem"
    content: "**The ultimate Rolls Royce**

    Unmatched prestige and comfort.

    * Seats 6 passengers
    * Limousine-length wheelbase
  ...
  - title: "Royal Treatment"
    icon: "fas fa-crown"
    content: "**VIP service included**

    The royal wedding car experience.
...
cta:
  enable: true
  title: "Book the Phantom V"
  content: "Our most prestigious vehicle - perfect for couples seeking the ultimate in luxury. Book early."
  background_class: ""
  button:
    enable: true
    label: "Contact Us"
